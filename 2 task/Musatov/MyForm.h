...
#pragma endregion
	private: System::Void MyForm_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {
		...
		//нижн€€ права€
		g->DrawLine(greenPen, ClientRectangle.Width, ClientRectangle.Height / 3, ClientRectangle.Width / 3, ClientRectangle.Height);
		//права€
		g->DrawLine(greenPen,  ClientRectangle.Width / 3, 0, ClientRectangle.Width, ClientRectangle.Height / 3);
		//лева€
		g->DrawLine(greenPen, 0, ClientRectangle.Height / 3, ClientRectangle.Width / 3, ClientRectangle.Height);
		//верхн€€ лева€
		g->DrawLine(greenPen, 0, ClientRectangle.Height / 3,  ClientRectangle.Width / 3, 0);
